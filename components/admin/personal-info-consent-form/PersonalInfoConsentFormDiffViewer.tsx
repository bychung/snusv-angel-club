...
import type { PersonalInfoConsentFormDiff } from '@/types/assemblies';
import { AlertCircle } from 'lucide-react';

interface PersonalInfoConsentFormDiffViewerProps {
  diff: PersonalInfoConsentFormDiff;
}

export default function PersonalInfoConsentFormDiffViewer({
  diff,
}: PersonalInfoConsentFormDiffViewerProps) {
  if (!diff.hasChanges) {
    return null;
  }
